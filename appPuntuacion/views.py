...
def localidadSelect(request):
    ...
    return render(request, 'appPuntuacion/localidadSelect.html', {'NombreLocalidad':nombreLocalidad, 'PuntuacionLocalidad':dumps(puntuacionLocalidad), 'MaxPuntuacion':dumps(maxPuntuacion["puntuacion__max"])})
